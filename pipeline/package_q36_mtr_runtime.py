...
REQUIRED = {
    ...
    "pipeline/render_upward_moe_scaling.py",
    ...
    "pipeline/build_gpt_oss_mxfp4_overlay.py",
    ...
    "pipeline/fetch_mixtral_8x22b.py",
    "pipeline/fetch_gpt_oss_120b.py",
    "pipeline/jobs/build_gpt_oss_mxfp4_overlay.sbatch",
    "pipeline/jobs/build_nemotron_scale_transfer_basis.sbatch",
    "pipeline/jobs/fetch_mixtral_8x22b.sbatch",
    "pipeline/jobs/fetch_gpt_oss_120b.sbatch",
    "pipeline/jobs/lift_nemotron_super_adapter_to_ultra.sbatch",
    "pipeline/jobs/render_upward_moe_scaling.sbatch",
    "pipeline/jobs/mixtral_8x22b_score.sbatch",
    "pipeline/jobs/nemotron_ultra_score.sbatch",
    "pipeline/jobs/q36_mtr_external_forest.sbatch",
    "pipeline/jobs/q36_mtr_live_preflight.sbatch",
    "pipeline/jobs/q36_mtr_prepare_phase.sh",
    "pipeline/jobs/q36_mtr_score_temporal_gate.sbatch",
    "pipeline/merge_q36_mtr_drafts.py",
    "pipeline/merge_upward_moe_drafts.py",
    ...
    "pipeline/score_nemotron_ultra_screen.py",
    "pipeline/score_q36_mtr_external_consensus.py",
    "pipeline/score_q36_mtr_external_forest.py",
    "pipeline/score_q36_mtr_temporal_gate.py",
    "pipeline/score_upward_moe_temporal_gate.py",
    ...
    "train/hf_nemotron_super_mechanics.py",
    "train/hf_gpt_oss_120b_mechanics.py",
    "train/hf_nemotron_super_evaluate.py",
    "train/hf_nemotron_super_train_revision.py",
    "train/hf_nemotron_ultra_evaluate.py",
    "train/hf_nemotron_ultra_mechanics.py",
    "train/hf_nemotron_ultra_train_revision.py",
    "train/hf_mixtral_8x22b_evaluate.py",
    "train/hf_mixtral_8x22b_mechanics.py",
    "train/hf_mixtral_8x22b_train_revision.py",
    "train/hf_upward_moe_train_owner.py",
    "train/hf_upward_moe_train_aligned.py",
    "train/hf_upward_moe_generate_drafts.py",
    "train/hf_upward_moe_evaluate_temporal_gate.py",
    "train/hf_upward_moe_train_temporal_gate.py",
    "train/hf_q36_mtr_evaluate.py",
    "train/hf_q36_mtr_evaluate_temporal_gate.py",
    "train/hf_q36_mtr_external_evaluate.py",
    ...
    "train/jobs/nemotron_ultra_train_revision.sbatch",
    "train/jobs/mixtral_8x22b_evaluate.sbatch",
    "train/jobs/mixtral_8x22b_mechanics.sbatch",
    "train/jobs/mixtral_8x22b_train_revision.sbatch",
    "train/jobs/q36_mtr_common.sh",
    "train/jobs/q36_mtr_evaluate_temporal_gate.sbatch",
    "train/jobs/q36_mtr_train_temporal_gate.sbatch",
    "train/jobs/upward_moe_train_owner.sbatch",
    "train/jobs/upward_moe_train_aligned.sbatch",
    "train/jobs/upward_moe_generate_drafts.sbatch",
    "train/jobs/upward_moe_evaluate_temporal_gate.sbatch",
    "train/jobs/upward_moe_train_temporal_gate.sbatch",
    "pipeline/jobs/merge_upward_moe_drafts.sbatch",
    "pipeline/jobs/materialize_upward_moe_data.sbatch",
    "pipeline/jobs/score_upward_moe_temporal_gate.sbatch",
    "train/jobs/q36_mtr_external_evaluate.sbatch",
    "pipeline/jobs/q36_mtr_external_score.sbatch",
    "pipeline/jobs/nemotron_super_score.sbatch",
    ...
    "train/mixtral_post_mlp_revision.py",
    "train/gpt_oss_post_mlp_revision.py",
    "train/pcf1_code_sandbox.py",
    "train/q36_mtr_roles.py",
    "train/q36_upward_moe_host.py",
    "train/q36_upward_moe_gpt_oss_host.py",
    "train/q36_upward_moe_mixtral_host.py",
