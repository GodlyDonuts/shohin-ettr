...
def test_fresh_executor_receives_state_and_post_seal_command(
    ...
    manifest = ETTRFactorialExecutionManifest(
        ...
        world_runtime_bundle_sha256="d" * 64,
        command_runtime_bundle_sha256="5" * 64,
        query_runtime_bundle_sha256="e" * 64,
        claim_runtime_archive_sha256="6" * 64,
        claim_runtime_archive_size=1,
        claim_runtime_inventory_sha256="7" * 64,
        external_launcher_sha256="8" * 64,
        bwrap_sha256="9" * 64,
        network_namespace_required=True,
        world_stage_policy_sha256="a" * 64,
        command_stage_policy_sha256="b" * 64,
        query_stage_policy_sha256="c" * 64,
