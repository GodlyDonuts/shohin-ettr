...
def test_external_signature_rejects_self_attestation_and_wrong_key() -> None:
    ...
    launch_verifier_public_key = launch_verifier_key.public_key().public_bytes(
        encoding=serialization.Encoding.Raw,
        format=serialization.PublicFormat.Raw,
    )
    claim_runtime_receipt_sha256 = "e" * 64
    authority = make_root_signed_ettr_custody_authority(
        root_private_key=root_key,
        custody_public_key_hex=public_key_hex,
        launch_verifier_public_key_hex=(launch_verifier_public_key.hex()),
    ...
    seal = _sign_custody_chain_unchecked(
        ...
        world_launch_receipt_sha256="b" * 64,
        command_launch_receipt_sha256="c" * 64,
        query_launch_receipt_sha256="d" * 64,
        claim_runtime_verification_receipt_sha256=(claim_runtime_receipt_sha256),
