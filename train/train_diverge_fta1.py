#!/usr/bin/env python3
"""Train the one frozen DIVERGE-FTA1 finite-state source compiler."""
...
from diverge_ats1_runtime import compiler_loss
from diverge_fta1_runtime import FTA1Config, FiniteStateSourceCompiler


SCHEMA = "shohin-diverge-fta1-training-report-v1"
...
def main() -> None:
    ...
    parser.add_argument("--seed", type=int, default=2026080607)
    ...
    config = FTA1Config(width=args.width, layers=args.layers)
    ...
    for update in range(1, args.updates + 1):
        ...
        if update == 1 or update % args.log_interval == 0 or update == args.updates:
            record = {"update": update, "learning_rate": learning_rate, **metrics}
