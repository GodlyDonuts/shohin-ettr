...
gpt_common="PYTHON=$PYTHON,RUNTIME=$RUNTIME,RUNTIME_MANIFEST_SHA256=$RUNTIME_MANIFEST_SHA256,MODEL_ROOT=$GPT_MODEL_ROOT,OVERLAY_ROOT=$OVERLAY_ROOT,OVERLAY_REPORT=$OVERLAY_REPORT,MECHANICS_REPORT=$MECHANICS_REPORT"
