...
\begin{figure*}[t]
  ...
  \caption{\textbf{Learned ownership across inference time.} (a) In the dense
  lifecycle, a model-owned draft feeds matched unchanged and trained-revision
  roles; commitment selects one whole trajectory. (b) The sparse-host revision
  surface augments the final
